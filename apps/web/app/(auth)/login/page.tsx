...
export default function LoginPage() {
  ...
  async function handleGitHub() {
    await signIn.social({ provider: "github", callbackURL: "/discover" });
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-trevo-bg">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          ...
          <p className="text-sm text-trevo-text-secondary">Welcome back. Continue building trust.</p>
        </div>
        ...
        <p className="text-sm text-trevo-text-secondary mt-6 text-center">
          No account?{" "}
          <Link href="/register" className="text-trevo-accent hover:underline">
            Register
          </Link>
        </p>
      </div>
